  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      if (!admin) {
        ...
        // Admin email signed up via Google — route to admin dashboard
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-yellow-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center mb-8">
        ...
        <h1 className="text-2xl font-extrabold text-gray-900">Create a Parent Account</h1>
        <p className="mt-2 text-sm text-gray-500">
          Already have an account?{" "}
          <Link href="/auth/login" className="font-semibold text-yellow-600 hover:text-yellow-500 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-6 shadow-xl rounded-2xl border border-gray-100">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-white text-gray-400 font-medium uppercase tracking-wider">or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailSignup} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent text-sm text-gray-900 transition-all"
              />
              <p className="mt-1.5 text-xs text-gray-400">At least 8 characters with letters and numbers.</p>
            </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          By signing up, you agree to Spoorthi's Privacy Policy and Terms.
        </p>
      </div>
    </div>
  );
