...
export default function AboutPage() {
  ...
  return (
    <main className="overflow-hidden">
      ...
      {/* ═══════════════════  VISION & MISSION  ═══════════════════ */}
      <section className="py-24 px-6 bg-gradient-to-br from-gray-50 via-white to-yellow-50/30">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-yellow-400 to-amber-500 rounded-3xl transform rotate-1 group-hover:rotate-2 transition-transform duration-500 opacity-90" />
              <div className="relative bg-white rounded-3xl p-10 shadow-lg border border-gray-100 group-hover:-translate-y-1 transition-transform duration-500">
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  To be a beacon of educational excellence that inspires lifelong learners, nurtures creative
                  thinkers, and shapes responsible global citizens who contribute positively to society.
                </p>
                <div className="mt-6 flex items-center gap-3">
                  <div className="w-10 h-1 rounded-full bg-yellow-400" />
                  <span className="text-xs font-bold text-yellow-600 uppercase tracking-wider">Illuminating Futures</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative group"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-red-400 to-rose-500 rounded-3xl transform -rotate-1 group-hover:-rotate-2 transition-transform duration-500 opacity-90" />
              <div className="relative bg-white rounded-3xl p-10 shadow-lg border border-gray-100 group-hover:-translate-y-1 transition-transform duration-500">
                <div className="w-16 h-16 rounded-2xl bg-red-50 flex items-center justify-center mb-6">
                  <svg className="w-8 h-8 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                </div>
                <h3 className="text-2xl font-black text-gray-900 mb-4">Our Mission</h3>
                <p className="text-gray-600 leading-relaxed text-lg">
                  To provide holistic education that integrates academic rigour with creativity, technology,
                  and values — empowering every child to discover their unique potential and excel in an
                  ever-changing world.
                </p>
                <div className="mt-6 flex items-center gap-3">
                  <div className="w-10 h-1 rounded-full bg-red-400" />
                  <span className="text-xs font-bold text-red-600 uppercase tracking-wider">Empowering Minds</span>
                </div>
              </div>
            </motion.div>
          </div>
