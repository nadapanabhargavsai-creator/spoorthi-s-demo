      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-900">
              Fee <span className="text-yellow-500">Structure Overview</span>
            </h2>
            <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
              Our school maintains competitive and affordable pricing to support high-quality education parameters.
            </p>
          </m.div>

          <div className="grid lg:grid-cols-3 gap-8">
            {/* Pre-Primary Fee Card */}
            <m.div
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-80px" }}
              variants={scaleUp}
              className="bg-slate-50 rounded-3xl p-8 border border-gray-150 flex flex-col justify-between"
            >
              <div>
                <h3 className="text-xl font-black text-gray-900 mb-2">Pre-Primary</h3>
                <p className="text-xs text-gray-400 uppercase font-black tracking-wider mb-6">Nursery, LKG, UKG</p>
                <div className="border-t border-gray-250/50 pt-6 space-y-3 mb-6">
                  <div className="flex justify-between text-xs font-bold text-gray-600"><span>Registration Fee (One-time):</span> <span className="text-gray-900">₹2,000</span></div>
                  <div className="flex justify-between text-xs font-bold text-gray-600"><span>Tuition Fee (Annually):</span> <span className="text-gray-900">₹32,000</span></div>
                  <div className="flex justify-between text-xs font-bold text-gray-600"><span>Activity & Exam Fee:</span> <span className="text-gray-900">₹5,000</span></div>
                </div>
              </div>
              <div className="border-t border-gray-250/50 pt-6">
                <span className="text-3xl font-black text-gray-900">₹39,000</span>
                <span className="text-xs text-gray-400 ml-2">Total / Year</span>
              </div>
            </m.div>
            ...
            <m.div
              ...
              className="bg-slate-50 rounded-3xl p-8 border border-yellow-400 shadow-xl shadow-yellow-500/5 flex flex-col justify-between relative"
            >
              <div className="absolute top-0 right-8 -translate-y-1/2 bg-yellow-500 text-black px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider">
                Popular
              </div>
              <div>
                <h3 className="text-xl font-black text-gray-900 mb-2">Primary (Grade 1-4)</h3>
                <p className="text-xs text-gray-400 uppercase font-black tracking-wider mb-6">Foundational Years</p>
                <div className="border-t border-gray-250/50 pt-6 space-y-3 mb-6">
                  <div className="flex justify-between text-xs font-bold text-gray-600"><span>Registration Fee (One-time):</span> <span className="text-gray-900">₹2,000</span></div>
                  <div className="flex justify-between text-xs font-bold text-gray-600"><span>Tuition Fee (Annually):</span> <span className="text-gray-900">₹42,000</span></div>
                  <div className="flex justify-between text-xs font-bold text-gray-600"><span>Lab & Digital System Fee:</span> <span className="text-gray-900">₹6,000</span></div>
                </div>
              </div>
              <div className="border-t border-gray-250/50 pt-6">
            ...
            >
              <div>
                <h3 className="text-xl font-black text-gray-900 mb-2">Primary (Grade 5-7)</h3>
                <p className="text-xs text-gray-400 uppercase font-black tracking-wider mb-6">Advanced Years</p>
                <div className="border-t border-gray-250/50 pt-6 space-y-3 mb-6">
                  <div className="flex justify-between text-xs font-bold text-gray-600"><span>Registration Fee (One-time):</span> <span className="text-gray-900">₹2,000</span></div>
                  <div className="flex justify-between text-xs font-bold text-gray-600"><span>Tuition Fee (Annually):</span> <span className="text-gray-900">₹48,000</span></div>
                  <div className="flex justify-between text-xs font-bold text-gray-600"><span>Lab & Digital System Fee:</span> <span className="text-gray-900">₹8,000</span></div>
                </div>
              </div>
              <div className="border-t border-gray-250/50 pt-6">
                <span className="text-3xl font-black text-gray-900">₹58,000</span>
                <span className="text-xs text-gray-400 ml-2">Total / Year</span>
              </div>
            </m.div>
          </div>
          ...
          <div className="mt-16 bg-yellow-50/50 border border-yellow-250/40 rounded-3xl p-8">
            <h3 className="text-xl font-black text-gray-900 mb-4">Admission Guidelines</h3>
            <div className="grid md:grid-cols-2 gap-8 text-xs text-gray-600 leading-relaxed font-medium">
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-yellow-500 shrink-0 mt-1.5" />
                  Fees can be deposited in 3 installments (Term 1: 50%, Term 2: 25%, Term 3: 25%).
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-yellow-500 shrink-0 mt-1.5" />
                  Transport facility fees are separately calculated based on distance kilometers.
                </li>
              </ul>
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-yellow-500 shrink-0 mt-1.5" />
                  Fee refunds are not applicable post the commencement of classes under any terms.
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-yellow-500 shrink-0 mt-1.5" />
                  Late payments will attract penalty fees as regulated by school guidelines.
                </li>
              </ul>
            </div>
          </div>
